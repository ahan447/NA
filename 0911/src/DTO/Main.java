...
public class Main {
	...
	public static void main(String[] args) {
		...
		UserVO vo2 = new UserVO(2, "후란",27);
		
		//객체의 모든 속성 확인하기
		//데이터를 표현하는 클래스를 만들 때는 toString()을 오버라이딩 하고
		//확인할 때는 아래처럼 이름만으로 확인
		//toString() 메소드를 디버깅을 위한 메소드라고도 함.
		System.out.printf("%s\n" , vo2);
		
		//UserVO 인스턴스를 생성
		UserVO vo3 = new UserVO(3, "이", 22);
		//v03가 가르키고 있는 곳을 참조를 vo4에 복사
		UserVO vo4 = vo3; //실제 이런 문장이 있다면 잘못된 것
		//vo4가 자신의 num을 31로 변경
		vo4.setNum(31);
		//vo3을 출력 - vo3의 num도 31 로 변경되어 있음.
		System.out.printf("%s\n", vo3);
